...
CREATE TABLE film (
  ...
  video_quality VARCHAR(10)
	director INTEGER REFERENCES person_id
	scenario INTEGER REFERENCES person_id
	producer INTEGER REFERENCES person_id
  operator INTEGER REFERENCES person_id
	composer INTEGER REFERENCES person_id
	artist INTEGER REFERENCES person_id
